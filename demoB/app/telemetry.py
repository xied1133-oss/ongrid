...
# --- Prometheus 指标 ---
REQUESTS = Counter("order_requests_total", "order-svc HTTP 请求数", ["endpoint", "code"])
DURATION = Histogram("order_duration_seconds", "order-svc HTTP 请求耗时", ["endpoint"])
UPSTREAM_ERRORS = Counter("order_upstream_errors_total", "order-svc 上游依赖失败数", ["upstream", "reason"])
CIRCUIT_OPEN = Gauge("order_circuit_open", "order-svc 熔断器状态 0=关闭 1=打开")
